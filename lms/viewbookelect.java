...
public class viewbookelect {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					viewbookelect window = new viewbookelect();
	...
	private void initialize() {
		...
		btnYes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					ResultSet rs = st.executeQuery("select * from addbooelec");
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					java.sql.Connection con = lms.MydbConnectionClass.getConnection();
					String sql = "select * from addbooelec where name=?";
		...
		lblNewLabel.setIcon(new ImageIcon(viewbookelect.class.getResource("/SS/IMG-20190817-WA0006.jpg")));
